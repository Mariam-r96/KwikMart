...
const SignUp = () =>{ 
    return(
        <div>
            <h1 className='text-center text-xl text-primary-800 font-semibold mb-8'>REGISTER</h1>
            <Formik
            initialValues={{
                firstName: '',
                lastName: '',
            ...
            handleChange, }) => (
                ...
                <button className='bg-primary-900 px-5 py-4 mt-6 text-white rounded-md' type="submit">Register</button>
                </Form>
            )}
            </Formik>
        </div>
